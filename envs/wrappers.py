...
class CollectDataset:
    ...
    def step(self, action):
        ...
        transition["arrived_s"] = info["arrived_s"]
        transition["rule_score"] = info["rule_score"]
        transition["finished_score"] = info["finished_score"]
        ...
        if done:
            ...
            for callback in self._callbacks:
                callback(episode, np.array(info["camera_v"]), np.array(info["rule_paras"]), np.array(info["anomaly"]))
